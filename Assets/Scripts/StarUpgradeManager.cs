...
public class StarUpgradeManager : MonoBehaviour
{
    ...
    public int upgradeCost = 2; // Cost of the upgrade
    ...
    private void ApplyUpgradeEffect()
    {
        ...
        {
            scoreManager.autoClickValue = scoreManager.realAutoClickValue * upgradeIncrement;
            UpdateSprite(upgradeGameObject, upgradeSprites, upgradeLevel);
        }
        else if (upgradeType == "Click Power")
        {
            scoreManager.clickValue = scoreManager.realClickValue * upgradeIncrement;
            UpdateSprite(upgradeGameObject, upgradeSprites, upgradeLevel);
        }
