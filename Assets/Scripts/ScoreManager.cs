...
public class ScoreManager : MonoBehaviour
{
    ...
    public float totalStarsEarned;
    public float neoCoins; // Monedas
    public float neoStars; // Estrellas
    public float realClickValue; // Valor de las monedas ganadas por click
    public float clickValue; // Valor de las monedas ganadas con el multiplicador
    public float realAutoClickValue; // Valor de las monedas ganadas por segundo
